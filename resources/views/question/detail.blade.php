	...
	<div class="row">
		<div class="col text-right">
			<div class="d-flex justify-content-end pr-2">
				<a href="{{ route('question.list', $area )}}"" class="btn btn-danger ml-2" style="width: 150px;"><i class="fas fa-chevron-left"></i> Back </a>
				<a href="{{ route('answer.create', $question) }}" class="btn btn-success ml-2" style="width: 150px;"><i class="fas fa-plus"></i> Create Answer </a>
			</div>
		</div>
	</div>
</div>
...
<div class="row p-2">
	<div class="col-12 p-2">
		...
		<p class="text-muted text-right">
			<em>Score Point = Question Weight x Answer Point</em>
		</p>
	</div>
</div>
 @section('js')
<script>let table = new DataTable('#answer_detail');</script>
		@endsection
@endsection