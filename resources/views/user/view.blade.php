        ...
        <form action="{{ route('question.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nik" placeholder="{{ $users->nik }}" name="nik">
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail1">Name</label>
                    <input type="text" class="form-control" id="weight" placeholder="{{ $users->name }}" name="weight">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Email</label>
                    <input type="email" class="form-control" id="weight" placeholder="{{ $users->email }}" name="weight">
                </div>


                <div class="form-group">
                    <label for="exampleInputEmail1">Position</label>
                    <input type="text" class="form-control" id="weight" placeholder="{{ $users->position }}" name="weight">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Division</label>
                    <input type="text" class="form-control" id="weight" placeholder="{{ $users->division }}" name="weight">
                </div>
                <div class="form-group">
